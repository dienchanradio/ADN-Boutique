      ...
      <aside className="border-b bg-muted/20 md:sticky md:top-0 md:flex md:h-screen md:flex-col md:border-b-0 md:border-r">
        <div className="border-b px-5 py-5">
          <div className="flex items-center gap-3">
            <BrandMark size="sm" alt="Diện Chẩn Boutique" />
            <div>
              <p className="font-serif text-sm font-semibold text-accent">{DESIGN_SYSTEM.title}</p>
              <p className="mt-1 text-xs text-muted-foreground">Living visual language</p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          <header className="border-b pb-8">
            <div className="mb-6 flex items-center gap-3">
              <BrandMark size="md" alt="Diện Chẩn Boutique" />
