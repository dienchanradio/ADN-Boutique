# Consuming Diện Chẩn Kích Hoạt ADN Design System in Expo apps

Read `artifacts/dien-chan-adn-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/dien-chan-adn-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/dien-chan-adn-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/dien-chan-adn-design-system/lib/native-theme";
import { useColors } from "@workspace/dien-chan-adn-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/dien-chan-adn-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/dien-chan-adn-design-system/components/native/badge";
import { Button } from "@workspace/dien-chan-adn-design-system/components/native/button";
import { Card } from "@workspace/dien-chan-adn-design-system/components/native/card";
```
...
Import and render
`@workspace/dien-chan-adn-design-system/components/native/button`, then run Expo
