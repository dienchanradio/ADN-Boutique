# Consuming Diện Chẩn Kích Hoạt ADN Design System in web apps

Read `artifacts/dien-chan-adn-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/dien-chan-adn-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/dien-chan-adn-design-system/styles.css";
```
...
`node_modules/@workspace/dien-chan-adn-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/dien-chan-adn-design-system/components/ui/button";
import { cn } from "@workspace/dien-chan-adn-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/dien-chan-adn-design-system/hooks/use-toast";
```
...
`@workspace/dien-chan-adn-design-system/components/ui/button`. Run the app's typecheck
