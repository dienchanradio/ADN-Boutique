# Migrating web UI to Diện Chẩn Kích Hoạt ADN Design System

Read `artifacts/dien-chan-adn-design-system/docs/AGENTS.md` and
`artifacts/dien-chan-adn-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/dien-chan-adn-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/dien-chan-adn-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/dien-chan-adn-design-system/hooks/use-toast`
